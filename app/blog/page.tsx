    ...
    <main style={{ background: '#0C0C0C', color: '#F5F0E8', minHeight: '100vh' }}>
      ...
      <section className="text-center" style={{
        ...
        <p style={{
          ...
          textTransform: 'uppercase', fontFamily: 'var(--font-playfair)', fontStyle: 'italic', marginBottom: 16
        }}>
          Real Estate Column
        </p>
        <h1 style={{
              ...
              <Link key={post.slug} href={`/blog/${encodeURIComponent(post.slug)}`} className="group">
                <article className="luxury-card h-full flex flex-col overflow-hidden">
                  ...
                  <div className="p-6 flex flex-col flex-1" style={{ background: '#1C1C1C' }}>
                    ...
                    <h2 className="text-lg font-semibold leading-snug mb-3 transition-colors duration-200"
                    ...
                    <div className="flex items-center justify-between mt-5 pt-4"
                      ...
                      <p className="text-xs" style={{ color: '#3A3A3A' }}>{formatDateTW(post.date)}</p>
